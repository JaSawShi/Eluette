#all animations and yes i have some bugs in my animation, creted 7 nov 2024
import pygame, sys
...
attack_images = load_frames('images/player/attack/Eluette_attack', 4)
shot_images = load_frames('images/player/shot/Eluette_shot', 6)  # New shot animation
